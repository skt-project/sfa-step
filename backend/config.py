...
class Settings(BaseSettings):
    ...
    cors_origins: str = "https://sfa-step.vercel.app/login https://step.netlify.app http://localhost:8080 http://localhost:8081 http://localhost:19006 http://localhost:19000"
